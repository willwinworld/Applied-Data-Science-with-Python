...
def answer_two():
    ...
    rec_score = recall_score(y_test, dummy_predicted)
#     print(acc_score)
#     print(rec_score)
...
def answer_three():
    ...
    rec_score = recall_score(y_test, svm_predicted)
    pre_score = precision_score(y_test, svm_predicted)
    
#     print(accuracy_score)
#     print(rec_score)
#     print(pre_score)
    return accuracy_score, rec_score, pre_score
